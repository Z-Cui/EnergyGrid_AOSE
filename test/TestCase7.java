	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			ac7 = mc.createNewAgent("Consumer01", ConsumerAgent.class.getName(),
					new Object[] { 40.00, new String("Renewable"), 2.00, 1.5, 5.1, 4.2, new int[] { 10, 11 }, new int[] { 20, 30 } });
			ac7.start();
			ac8 = mc.createNewAgent("Consumer02", ConsumerAgent.class.getName(),
					new Object[] { 10.00, new String("Renewable"), 2.00, 1.5, 5.1, 4.2, new int[] {10,11}, new int[] {10,40} });
			ac8.start();
