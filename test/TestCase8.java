...
public class TestCase8 {
	public static void main(String[] args) throws InterruptedException {
		...
		AgentController ac1, ac2, ac3, ac4, ac5, ac6, ac7, ac8, ac9, ac10, ac11, ac12, ac13, ac14, ac15, ac16;
		...
		try {
			...
			ac4.start();
			Thread.sleep(5000);
			ac14 = mc.createNewAgent("Producer02", ProducerAgent.class.getName(),
					new Object[] { new int[] { 10, 11 }, new int[] { 100, 120 },
							new String[] { "nonRenewable", "nonRenewable" }, new Double[] { 1.1, 1.2 } });
			ac14.start();
			Thread.sleep(5000);
			ac15 = mc.createNewAgent("Producer03", ProducerAgent.class.getName(),
					new Object[] { new int[] { 10, 11 }, new int[] { 100, 120 },
							new String[] { "nonRenewable", "nonRenewable" }, new Double[] { 1.1, 1.2 } });
			ac15.start();
			Thread.sleep(5000);
			ac16 = mc.createNewAgent("Producer04", ProducerAgent.class.getName(),
					new Object[] { new int[] { 10, 11 }, new int[] { 100, 120 },
							new String[] { "nonRenewable", "nonRenewable" }, new Double[] { 1.1, 1.2 } });
			ac16.start();
			Thread.sleep(5000);
			...
			ac8.start();
			ac9 = mc.createNewAgent("Consumer03", ConsumerAgent.class.getName(),
					new Object[] { 100.00, new String("nonRenewable"), 2.00, 1.5, 5.1, 4.2, new int[] { 10, 11 }, new int[] { 20, 30 } });
			ac9.start();
			ac10 = mc.createNewAgent("Consumer04", ConsumerAgent.class.getName(),
					new Object[] { 100.00, new String("nonRenewable"), 2.00, 1.5, 5.1, 4.2, new int[] {10,11}, new int[] {10,40} });
			ac10.start();
			ac11 = mc.createNewAgent("Consumer05", ConsumerAgent.class.getName(),
					new Object[] { 100.00, new String("nonRenewable"), 2.00, 1.5, 5.1, 4.2, new int[] { 10, 11 }, new int[] { 20, 30 } });
			ac11.start();
			ac12 = mc.createNewAgent("Consumer06", ConsumerAgent.class.getName(),
					new Object[] { 100.00, new String("nonRenewable"), 2.00, 1.5, 5.1, 4.2, new int[] {10,11}, new int[] {10,40} });
			ac12.start();
			ac13 = mc.createNewAgent("Consumer07", ConsumerAgent.class.getName(),
					new Object[] { 100.00, new String("nonRenewable"), 2.00, 1.5, 5.1, 4.2, new int[] { 10, 11 }, new int[] { 20, 30 } });
			ac13.start();
