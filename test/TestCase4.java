...
public class TestCase4 {
	public static void main(String[] args) throws InterruptedException {
		...
		AgentController ac1, ac2, ac3, ac4, ac5, ac6, ac7, ac8, ac9;
		...
		try {
			...
			ac4 = mc.createNewAgent("Producer01", ProducerAgent.class.getName(),
					new Object[] { new int[] { 16, 17 }, new int[] { 100, 120 },
							new String[] { "nonRenewable", "nonRenewable" }, new Double[] { 1.1, 1.2 } });
			ac4.start();
			Thread.sleep(5000);
			ac8 = mc.createNewAgent("Producer02", ProducerAgent.class.getName(),
					new Object[] { new int[] { 18, 19 }, new int[] { 100, 120 },
							new String[] { "nonRenewable", "nonRenewable" }, new Double[] { 1.1, 1.2 } });
			ac8.start();
			Thread.sleep(5000);
			...
			ac7 = mc.createNewAgent("Consumer01", ConsumerAgent.class.getName(),
					new Object[] { 100.00, new String("nonRenewable"), 2.00, 1.5, 5.1, 4.2, new int[] { 15, 16 }, new int[] { 20, 30 } });
			ac7.start();
